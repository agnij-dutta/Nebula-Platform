...
function App() {
    ...
    const [activeView, setActiveView] = useState<'browse' | 'create' | 'createIP' | 'research' | 'governance' | 'staking' | 'swap'>('browse');
                ...
                <div className="App wallet-not-connected">
                    <header className="App-header minimal">
                        <div className="header-content">
                            <div className="logo">Nebula Launchpad</div>
                        </div>
                    </header>
                    <main className="App-content">
                        <WalletPrompt 
                            message="Welcome to Nebula Launchpad! Connect your wallet to get started"
